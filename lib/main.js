...
export default {
  ...
  config: {
    ...
    "invertMode": {
      'order': 4,
      "title": "Inverse color",
      "description": "Inverts the colours of the pages. Restart needed. You can toggle this per Atom instance by command `pdf-viewer:invert-colors` or press `F2` in pdf-viewer or toggle it per file by `Alt-F2` in pdf-viewer",
      "type": "boolean",
      "default": false,
    },
  },
