...
export default class Viewer {
  ...
  constructor(filePath, hash) {
    ...
    this.file = new File(filePath) ; this.hash = hash ? hash : ''
    ...
    this.disposables.add(
      this.file.onDidChange(() => { this.refresh() }),
      this.file.onDidDelete(() => { this.destroy() }),
  ...
  refresh() {
    this.element.src = `${this.pdfjsPath}?file=${this.filePath}${this.hash}`
  }
